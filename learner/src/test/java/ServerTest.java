...
//
//        NanoHTTPD.Response response = getResponse(annotator, null, null, session);
//
...
//    }
//
//    private NanoHTTPD.Response getResponse(Annotator annotator, NanoHTTPD.IHTTPSession session) throws IOException
//    {
//        Server server = new Server(0,annotator,infoController,instanceController);
